...
def spawn_ball(direction):
    ...
    # position the ball at the centre of the canvas
    ball_pos = [WIDTH / 2, HEIGHT / 2]
    if direction == RIGHT:
        ball_vel = [random.randrange(
            120, 240) / 60, -(random.randrange(60, 180) / 60)]
    else:
...
def draw(canvas):
    ...
    canvas.draw_line([WIDTH - PAD_WIDTH / 2, paddle2_pos], [WIDTH -
                     PAD_WIDTH / 2, paddle2_pos + PAD_HEIGHT], PAD_WIDTH, "White")
